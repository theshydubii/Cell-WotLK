...
local function ShowBindingMenu(index, b)
    ...
    bindingButton:SetParent(b.keyGrid)
    bindingButton:SetFrameLevel(b.keyGrid:GetFrameLevel() + 50)
    ...
    elseif bindType == "custom" then
        ...
        tinsert(items, {
            ...
            ["onClick"] = function()
                ...
                peb:SetParent(b.actionGrid)
                peb:SetFrameLevel(b.actionGrid:GetFrameLevel() + 50)
